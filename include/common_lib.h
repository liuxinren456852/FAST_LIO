...
#define PLOT_AT_END  // using Matplotlib to draw figures at the end of whole application
//#define USING_CORNER  // using the corner features

#define PI_M          (3.14159265)
#define G_m_s2        (9.8099)  // Gravaty const in GuangDong.China, it is used as initial value
...
#define STD_VEC_FROM_EIGEN(mat)  std::vector<decltype(mat)::Scalar> (mat.data(), mat.data() + \
                                 mat.rows() * mat.cols())
